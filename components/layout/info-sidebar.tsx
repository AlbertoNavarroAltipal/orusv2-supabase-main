  ...
  return (
    <div className="bg-green-50 w-80 border-l border-gray-200 flex flex-col">
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        ...
        <Button variant="ghost" size="icon" onClick={toggleInfoSidebar} className="text-gray-500 hover:bg-green-100">
          <X className="h-5 w-5" />
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <p className="text-sm text-gray-600 mb-4">
          Esta sección solo se mostrará cuando el botón de ver información se le de click
        </p>
