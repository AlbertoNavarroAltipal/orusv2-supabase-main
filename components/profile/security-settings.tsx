...
export function SecuritySettings({ userId }: SecuritySettingsProps) {
  ...
  const handleTwoFactorToggle = (checked: boolean) => {
    ...
    toast({
      title: checked ? "Autenticación de dos factores habilitada" : "Autenticación de dos factores deshabilitada",
      description: checked
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <FormDescription>Protege tu cuenta con autenticación de dos factores</FormDescription>
            </div>
          ...
          <Alert variant="warning">
            ...
            <AlertDescription>
              La autenticación de dos factores está actualmente en desarrollo y no está disponible.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
